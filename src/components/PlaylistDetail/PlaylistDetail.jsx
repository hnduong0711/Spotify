...
function PlaylistDetail() {
  ...
  const playlist = {
    ...
    tracks: [
      ...
      {
        id: 15,
        title: 'Đâu Đương Xô Chó',
        artists: 'Obito, Shiki, Lang LD',
        album: 'Đành Đợi',
        duration: '3:04',
        image: 'https://via.placeholder.com/40',
      },
      ...
      {
        id: 18,
        title: 'Hào Quang (feat. RHYDER, Dương Domic & Phát Kiều)',
        artists: 'ANH TRAI "SAY HI", RHYDER, Dương Domic, Phát Kiều',
        album: 'ANH TRAI "SAY HI" (LIVE STAGE 2)',
        duration: '4:05',
        image: 'https://via.placeholder.com/40',
      },
      {
      ...
      },
      {
        id: 20,
        title: 'Bước Za Di Xa',
        artists: 'Wxrdie, Mar1ykid, Lucin3x',
        album: 'Bước Za Di Xa',
        duration: '2:48',
        image: 'https://via.placeholder.com/40',
      },
